...
build_bls12381_pairing_eq_contracts:
	cp inversemod_bls12381.huff build/
	python3 generator/generate_pairing_eqn_contract.py 2 > build/bls12_381_pairing_eq2.huff
	python3 generator/generate_pairing_eqn_contract.py 1 > build/bls12_381_pairing_eq1.huff

	node compile.js bls12_381_pairing_eq2.huff PAIRING_EQ2 > build/bls12_381_pairing_eq2.hex
	node compile.js bls12_381_pairing_eq1.huff PAIRING_EQ1 > build/bls12_381_pairing_eq1.hex
